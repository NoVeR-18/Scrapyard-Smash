        ...
        public class GameUtilsProcessor : IPreprocessBuildWithReport, IPostGenerateGradleAndroidProject {
            ...
            private void PatchManifest() {
                ...
                YCXmlHandler.UpdateDocument("Plugins/Android/AndroidManifest.xml", (xmlDocument, documentRoot) => {
                    YCXmlHandler.YCXmlAttribute namespaceAttribute = new YCXmlHandler.YCXmlAttribute("tools", YCXmlHandler.YCAttributeType.Xmlns, "http://schemas.android.com/tools");
                    YCXmlHandler.SetAttribute(documentRoot, namespaceAttribute);

                    YCXmlHandler.YCXmlAttribute nameAttribute = new YCXmlHandler.YCXmlAttribute("name", YCXmlHandler.YCAttributeType.Android, "android.adservices.AD_SERVICES_CONFIG");
                    YCXmlHandler.YCXmlAttribute resourceAttribute = new YCXmlHandler.YCXmlAttribute("resource", YCXmlHandler.YCAttributeType.Android, "@xml/ga_ad_services_config");
                    YCXmlHandler.YCXmlAttribute toolsAttribute = new YCXmlHandler.YCXmlAttribute("replace", YCXmlHandler.YCAttributeType.Tools, "android:resource");
                    YCXmlHandler.YCXmlElement propertyElement = new YCXmlHandler.YCXmlElement("/manifest/application", "property", nameAttribute, resourceAttribute, toolsAttribute);
                    YCXmlHandler.CreateElement(xmlDocument, documentRoot, propertyElement);
                });
#endif
            }
            ...
            [PostProcessBuild(45)] //45 because EDM generates the pod file at 40 and install the pods at 50
            public static void StripBitcode(BuildTarget buildTarget, string path) {
#if UNITY_IOS
                ...
                string command = "\n" +
                    ...
                    "    system(command)\n" +
                    "  end\n" +
                    "  # List of framework paths that require bitcode stripping\n" +
                    "  framework_paths = [\n" +
